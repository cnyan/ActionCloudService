...
"""
O_COLUMNS_NINE = ['AX', 'AY', 'AZ', 'WX', 'WY', 'WZ', 'HX', 'HY', 'HZ']
O_COLUMNS_E = ['ER', 'aAX', 'aAY', 'aAZ', 'aWX', 'aWY', 'aWZ', 'aHX', 'aHY', 'aHZ', 'bAX', 'bAY', 'bAZ', 'bWX', 'bWY',
               'bWZ', 'bHX', 'bHY', 'bHZ',
               'cAX', 'cAY', 'cAZ', 'cWX', 'cWY', 'cWZ', 'cHX', 'cHY', 'cHZ', 'dAX', 'dAY', 'dAZ', 'dWX', 'dWY', 'dWZ',
               'dHX', 'dHY', 'dHZ',
               'eAX', 'eAY', 'eAZ', 'eWX', 'eWY', 'eWZ', 'eHX', 'eHY', 'eHZ', 'fAX', 'fAY', 'fAZ', 'fWX', 'fWY', 'fWZ',
               'fHX', 'fHY', 'fHZ',
               'gAX', 'gAY', 'gAZ', 'gWX', 'gWY', 'gWZ', 'gHX', 'gHY', 'gHZ', 'ACC']
